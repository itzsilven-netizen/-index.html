...
Built from: Micah's Noble Cyber "screenplay" structure + Alex Hormozi's cold-call principles

---

## Core Principles (apply to every call)

- **First 7 seconds decide everything.** Strangers see you as a threat by default — bridge that gap fast with a permission-based opener, not a pitch.
- **Give away the value in under 30 seconds.** Don't build up to your point — lead with something that proves you can solve their problem better than they can.
...
**"I'm slammed / bad timing"**
> "No problem — I can make it easy on you. I'll send a calendar invite so our schedules line up automatically. If something comes up, just propose a new time — no back-and-forth needed."

---

## 5. Confirm & Close

> "Perfect, I've got you down for [day/time]. I'll send a calendar invite to this number/email — sound good?"

---

## Optional: High-Curiosity Voicemail / Opener Variant

For voicemail drops or a pattern-interrupt opener when the standard one gets brushed off fast:

> "Hey [Business Name], I'm calling about [a competitor or a specific pain point in their industry]. Give me a call back."

This works because it's specific, personalized, and triggers curiosity rather than a sales-defense reflex.
...
## Industry Variants (to build out)

Placeholders — fill in once specific verticals are chosen (e.g. medical offices, contractors, law firms, real estate):

- **[Industry 1]:** pain point + impact area to lead with
- **[Industry 2]:** pain point + impact area to lead with
- **[Industry 3]:** pain point + impact area to lead with
